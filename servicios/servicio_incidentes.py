            ...
            if (sinit == 1):
                ...
                if incoming_svr==service_name: # Check if the command is for me
                    ...
                    if command.split(",")[0] == "INS":
                        ins, viaje_id, hora, localizacion, descripcion = command.split(',')
                        query = "INSERT into incidentes (viaje_id, hora, localizacion, descripcion) values ('{}', '{}', '{}', '{}')".format(viaje_id, hora, localizacion, descripcion)
